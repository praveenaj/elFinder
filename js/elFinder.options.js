...
elFinder.prototype._options = {
	...
	commands : [
		...
		'cut', 'paste', 'edit', 'extract', 'archive', 'search', 'info', 'view', 'help', 'resize', 'sort', 'netmount', 'newsite', 'publish', 'editor', 'addgadget'
	],
	...
	contextmenu : {
		...
		files  : ['editor', '|', 'getfile', '|','open', 'quicklook', '|', 'download', '|', 'copy', 'cut', 'paste', 'duplicate', '|', 'rm', '|', 'edit', 'rename', 'resize', '|', 'info']
	},
